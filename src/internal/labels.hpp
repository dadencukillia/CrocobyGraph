...
namespace CrocobyGraph {
  ...
  [[nodiscard]] Vector2 get_label_position(const entt::registry& registry, entt::entity label_entity);
  [[nodiscard]] Vector2 get_label_size(const LabelEntity& label_entity);
  [[nodiscard]] Vector2 get_free_label_position(const entt::registry& registry, entt::entity free_label_entity);
  [[nodiscard]] Vector2 get_attach_label_position(const entt::registry& registry, entt::entity attach_label_entity);
